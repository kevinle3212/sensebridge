...
description:
    SenseBridge-tuned security review — runs the built-in security-review
    analysis, then layers project-specific privacy, model-license, and
    safety-boundary checks on top.
---
...
3. **Model provenance & license.** A newly vendored model or weights file is a
   ...
   [model-license-audit](../model-license-audit/SKILL.md)
