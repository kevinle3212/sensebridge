...
Launch the `code-reviewer` subagent on the diff (its adversarial framing and
exhaustive edge-case method now cover what Blind Hunter and Edge Case Hunter
used to split across two passes):
