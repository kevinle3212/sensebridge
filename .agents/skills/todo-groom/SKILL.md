...
name: todo-groom
description:
    Groom TODO.md — verify each open item against the current repo state,
    annotate completed ones per the file's completion rule, flag stale or
    superseded items, and report. Never silently deletes.
---
